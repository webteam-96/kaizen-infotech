      ...
      >
          ...
          <div data-el="s2par" className="flex flex-col items-center gap-12" style={{ transformStyle: 'preserve-3d' }}>
            <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-12" style={{ perspective: 800 }}>
              <div data-el="s2c1" className="flex h-[170px] w-[130px] flex-col items-center justify-center gap-3 rounded-[14px] border border-[var(--color-border)] bg-[var(--color-bg-secondary)] sm:h-[200px] sm:w-[160px]" style={{ transformStyle: 'preserve-3d' }}>
                ...
                <div className="text-[12px] font-medium uppercase tracking-[2px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>Button</div>
                <div className="text-[12px] text-[var(--color-text-tertiary)] opacity-50" style={{ fontFamily: 'var(--font-mono)' }}>misaligned</div>
              </div>
              <div data-el="s2c2" className="flex h-[170px] w-[130px] flex-col items-center justify-center gap-3 rounded-[14px] border border-[var(--color-border)] bg-[var(--color-bg-secondary)] sm:h-[200px] sm:w-[160px]" style={{ transformStyle: 'preserve-3d' }}>
                ...
                <div className="text-[12px] font-medium uppercase tracking-[2px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>Loading</div>
                <div className="text-[12px] text-[var(--color-text-tertiary)] opacity-50" style={{ fontFamily: 'var(--font-mono)' }}>3.2s</div>
              </div>
              <div data-el="s2c3" className="flex h-[170px] w-[130px] flex-col items-center justify-center gap-3 rounded-[14px] border border-[var(--color-border)] bg-[var(--color-bg-secondary)] sm:h-[200px] sm:w-[160px]" style={{ transformStyle: 'preserve-3d' }}>
                ...
                <div className="text-[12px] font-medium uppercase tracking-[2px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>Analytics</div>
              </div>
            </div>
            <div data-el="s2text" style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(32px, 4.5vw, 64px)', fontWeight: 900, textAlign: 'center', background: 'linear-gradient(135deg, rgba(0,0,0,.5), rgba(0,0,0,.2))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
          ...
          <div data-el="s3par" className="flex flex-col items-center gap-12" style={{ transformStyle: 'preserve-3d' }}>
            <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-12" style={{ perspective: 800 }}>
              <div data-el="s3c1" className="flex h-[170px] w-[130px] flex-col items-center justify-center gap-3 rounded-[14px] border border-[var(--color-border)] bg-[var(--color-bg-secondary)] sm:h-[200px] sm:w-[160px]" style={{ transformStyle: 'preserve-3d' }}>
                ...
                <div className="text-[12px] font-medium uppercase tracking-[2px] text-[var(--color-accent-primary)]" style={{ fontFamily: 'var(--font-mono)' }}>Aligned</div>
              </div>
              <div data-el="s3c2" className="flex h-[170px] w-[130px] flex-col items-center justify-center gap-3 rounded-[14px] border border-[var(--color-border)] bg-[var(--color-bg-secondary)] sm:h-[200px] sm:w-[160px]" style={{ transformStyle: 'preserve-3d' }}>
                ...
                <div className="text-[12px] font-medium uppercase tracking-[2px] text-[var(--color-accent-primary)]" style={{ fontFamily: 'var(--font-mono)' }}>Fast</div>
              </div>
              <div data-el="s3c3" className="flex h-[170px] w-[130px] flex-col items-center justify-center gap-3 rounded-[14px] border border-[var(--color-border)] bg-[var(--color-bg-secondary)] sm:h-[200px] sm:w-[160px]" style={{ transformStyle: 'preserve-3d' }}>
                ...
                <div className="text-[12px] font-medium uppercase tracking-[2px] text-[var(--color-accent-primary)]" style={{ fontFamily: 'var(--font-mono)' }}>Growing</div>
              </div>
            </div>
            <div className="text-center" style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(32px, 4.5vw, 64px)', fontWeight: 900, lineHeight: 1.4 }}>
          ...
          <div data-el="s4par" className="flex w-[min(92vw,960px)] flex-col items-center gap-9" style={{ transformStyle: 'preserve-3d' }}>
            <div className="flex w-full flex-col items-center justify-center gap-5 sm:flex-row sm:gap-8" style={{ perspective: 1000 }}>
              ...
              <div data-el="s4p1" className="w-full max-w-[420px] overflow-hidden rounded-[14px] border border-[var(--color-border)] bg-[var(--color-bg-secondary)] p-6 sm:flex-1" style={{ transformStyle: 'preserve-3d' }}>
                <div className="mb-4 text-[12px] font-bold uppercase tracking-[3px] text-[var(--color-accent-primary)]" style={{ fontFamily: 'var(--font-mono)' }}>Developer</div>
              ...
              <div data-el="s4p2" className="w-full max-w-[420px] overflow-hidden rounded-[14px] border border-[var(--color-border)] bg-[var(--color-bg-secondary)] p-6 sm:flex-1" style={{ transformStyle: 'preserve-3d' }}>
                <div className="mb-4 text-[12px] font-bold uppercase tracking-[3px] text-[var(--color-accent-secondary)]" style={{ fontFamily: 'var(--font-mono)' }}>Designer</div>
                <div className="flex flex-col gap-3.5">
                  <div className="flex items-center gap-3">
                    <div data-el="s4b1" className="h-8 rounded-md border border-[var(--color-border)] bg-[rgba(0,0,0,.02)]" style={{ width: 80 }} />
                    <span className="whitespace-nowrap text-[12px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>padding: <span ref={s4pxRef}>16px</span></span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div data-el="s4b2" className="h-2 rounded-sm border border-[var(--color-border)] bg-[rgba(0,0,0,.02)]" style={{ width: 140 }} />
                    <span className="whitespace-nowrap text-[12px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>grid aligned</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div data-el="s4b3" className="h-6 rounded-md border border-[var(--color-border)] bg-[rgba(0,0,0,.02)]" style={{ width: 60 }} />
                    <span className="whitespace-nowrap text-[12px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>balanced</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-10">
              <div className="text-center">
                <div ref={s4seoRef} className="text-[40px] font-bold tracking-[-2px]" style={{ fontFamily: 'var(--font-mono)' }}>#23</div>
                <div className="mt-1.5 text-[12px] uppercase tracking-[3px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>SEO Rank</div>
              </div>
              <div className="text-center">
                <div ref={s4convRef} className="text-[40px] font-bold tracking-[-2px]" style={{ fontFamily: 'var(--font-mono)' }}>2.1%</div>
                <div className="mt-1.5 text-[12px] uppercase tracking-[3px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>Conversion</div>
              </div>
              <div className="text-center">
                <div ref={s4perfRef} className="text-[40px] font-bold tracking-[-2px]" style={{ fontFamily: 'var(--font-mono)' }}>68</div>
                <div className="mt-1.5 text-[12px] uppercase tracking-[3px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>Perf Score</div>
              </div>
            </div>
            <div data-el="s4text" style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(28px, 3.8vw, 56px)', fontWeight: 900, background: 'linear-gradient(135deg, var(--color-text-primary), var(--color-accent-secondary))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
            ...
            <div data-el="s5dash" className="w-full overflow-hidden rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-secondary)] p-8" style={{ transformStyle: 'preserve-3d' }}>
              <div className="mb-7 flex flex-wrap justify-center gap-10">
                <div className="flex-1 text-center">
                  ...
                  <div className="mt-1 text-[12px] uppercase tracking-[3px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>Load Time</div>
                </div>
                <div className="flex-1 text-center">
                  ...
                  <div className="mt-1 text-[12px] uppercase tracking-[3px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>Traffic</div>
                </div>
                <div className="flex-1 text-center">
                  ...
                  <div className="mt-1 text-[12px] uppercase tracking-[3px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>Quality</div>
                </div>
              </div>
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  <div className="w-20 text-right text-[12px] uppercase tracking-[2px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>Speed</div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-20 text-right text-[12px] uppercase tracking-[2px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>Traffic</div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-20 text-right text-[12px] uppercase tracking-[2px] text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)' }}>Quality</div>
        ...
        <div data-el="sec6" className="pointer-events-none absolute inset-0 flex items-center justify-center opacity-0" style={{ transformStyle: 'preserve-3d' }}>
          <div data-el="s6par" className="flex flex-col items-center" style={{ transformStyle: 'preserve-3d' }}>
            ...
            <div data-el="s6sub" className="mt-7 text-[var(--color-text-tertiary)]" style={{ fontFamily: 'var(--font-mono)', fontSize: 12, letterSpacing: 5, textTransform: 'uppercase' }}>
              Custom Software{'\u00A0\u00B7\u00A0'}SEO{'\u00A0\u00B7\u00A0'}Marketing
            </div>
            <div data-el="s6tag" className="mt-11 opacity-0" style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(24px, 3vw, 42px)', fontWeight: 700, fontStyle: 'italic', background: 'linear-gradient(135deg, var(--color-accent-primary), var(--color-accent-secondary))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
              Built to Evolve.
            </div>
          </div>
        </div>
