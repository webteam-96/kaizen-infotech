...
// Brand blue (#2196F3) as an RGB triplet — replaces React Bits' purple default.
const DEFAULT_GLOW_COLOR = '33, 150, 243';
...
// Allow CSS custom properties in inline style objects without `any`.
...
export default function MagicBento({
  ...
  const shouldDisableAnimations = disableAnimations || reduceEffects;
